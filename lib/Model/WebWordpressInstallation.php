...
/**
 * WebWordpressInstallation Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebWordpressInstallation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.wordpressInstallation';
    ...
    protected static $openAPITypes = [
        ...
        'id' => 'string',
        'webPath' => 'string',
        'wordpress' => '\COMPITAUT\DirectAdminAPI\Model\WebWordpressInstance'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('webPath', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['webPath'] === null) {
            $invalidProperties[] = "'webPath' can't be null";
        }
     ...
     * Sets filePath
     *
     * @param string $filePath Installation location on file system relative to user home dir
     *
     * @return self
     */
     ...
     * Sets host
     *
     * @param string $host Server host name to reach DA installation
     *
     * @return self
     */
     ...
     * Sets webPath
     *
     * @param string $webPath Installation location on URL, non empty only for wordpress installations in a sub-directory
     *
     * @return self
     */
    ...
    {
        if (is_null($webPath)) {
            throw new \InvalidArgumentException('non-nullable webPath cannot be null');
        }
     ...
     * Gets wordpress
     *
     * @return \COMPITAUT\DirectAdminAPI\Model\WebWordpressInstance|null
     */
     ...
     * Sets wordpress
     *
     * @param \COMPITAUT\DirectAdminAPI\Model\WebWordpressInstance|null $wordpress wordpress
     *
     * @return self
     */
