...
/**
 * ApierrorPreHookError Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class ApierrorPreHookError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apierror.PreHookError';
    ...
    public const TYPE_PRE_HOOK_ERROR = 'PRE_HOOK_ERROR';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['exitCode'] === null) {
            $invalidProperties[] = "'exitCode' can't be null";
        }
