...
/**
 * WebLoginRequestOtp Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLoginRequestOtp implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web_LoginRequest_otp';
    ...
    */
     ...
     * Sets code
     *
     * @param string $code Two factor authentication OTP code
     *
     * @return self
     */
     ...
     * Sets remember
     *
     * @param bool $remember if set to true sets a cookie to bypass 2FA auth in subsequent log-in attempts
     *
     * @return self
     */
