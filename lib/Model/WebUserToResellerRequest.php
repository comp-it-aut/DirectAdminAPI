...
/**
 * WebUserToResellerRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebUserToResellerRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.userToResellerRequest';
    ...
    */
     ...
     * Sets creator
     *
     * @param string|null $creator If empty default admin account will be used as creator
     *
     * @return self
     */
