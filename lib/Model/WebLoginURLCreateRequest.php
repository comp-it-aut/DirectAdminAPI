...
/**
 * WebLoginURLCreateRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLoginURLCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.loginURLCreateRequest';
    ...
    */
     ...
     * Sets expires
     *
     * @param \DateTime|null $expires Defaults to `login_hash_expiry_minutes`.
     *
     * @return self
     */
