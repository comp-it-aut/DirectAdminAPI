...
/**
 * WebDbCreateDatabaseRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebDbCreateDatabaseRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.dbCreateDatabaseRequest';
    ...
    */
     ...
     * Sets charset
     *
     * @param string|null $charset If empty, uses default server charset.
     *
     * @return self
     */
     ...
     * Sets collation
     *
     * @param string|null $collation If empty, uses default server collation.
     *
     * @return self
     */
