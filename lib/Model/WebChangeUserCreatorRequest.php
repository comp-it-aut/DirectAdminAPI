...
/**
 * WebChangeUserCreatorRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebChangeUserCreatorRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.changeUserCreatorRequest';
    ...
    */
     ...
     * Sets account
     *
     * @param string $account Username which creator is being changed
     *
     * @return self
     */
     ...
     * Sets creator
     *
     * @param string $creator Username of the new user creator account
     *
     * @return self
     */
