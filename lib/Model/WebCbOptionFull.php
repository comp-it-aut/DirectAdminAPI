...
/**
 * WebCbOptionFull Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebCbOptionFull implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.cbOptionFull';
    ...
    */
     ...
     * Sets allowed
     *
     * @param string[] $allowed list of allowed option values, empty if any value is allowed
     *
     * @return self
     */
     ...
     * Sets key
     *
     * @param string $key option key, same as in options.conf file
     *
     * @return self
     */
     ...
     * Sets section
     *
     * @param string $section internal identifier of the options section
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value currently set option value
     *
     * @return self
     */
