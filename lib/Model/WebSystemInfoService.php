...
/**
 * WebSystemInfoService Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebSystemInfoService implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.systemInfoService';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('isRunning', $data ?? [], null);
    ...
    */
     ...
     * Sets inUse
     *
     * @param bool $inUse InUse reports whether service is selected to be used in `directadmin.conf`.
     *
     * @return self
     */
     ...
     * Sets isRunning
     *
     * @param bool $isRunning isRunning
     *
     * @return self
     */
