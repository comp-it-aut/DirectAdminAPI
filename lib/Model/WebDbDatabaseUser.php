...
/**
 * WebDbDatabaseUser Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebDbDatabaseUser implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.dbDatabaseUser';
    ...
    protected static $setters = [
        'conflictingHosts' => 'setConflictingHosts',
        'dbuser' => 'setDbuser',
    ...
    protected static $getters = [
        'conflictingHosts' => 'getConflictingHosts',
        'dbuser' => 'getDbuser',
    ...
    {
        $this->setIfExists('conflictingHosts', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['conflictingHosts'] === null) {
            $invalidProperties[] = "'conflictingHosts' can't be null";
        }
    ...
    /**
     * Gets conflictingHosts
     *
     * @return bool
     */
    public function getConflictingHosts()
    {
        return $this->container['conflictingHosts'];
    }

    /**
     * Sets conflictingHosts
     *
     * @param bool $conflictingHosts Reports whether privileges differ between hosts.
     *
     * @return self
     */
    public function setConflictingHosts($conflictingHosts)
    {
        if (is_null($conflictingHosts)) {
            throw new \InvalidArgumentException('non-nullable conflictingHosts cannot be null');
        }
        $this->container['conflictingHosts'] = $conflictingHosts;
