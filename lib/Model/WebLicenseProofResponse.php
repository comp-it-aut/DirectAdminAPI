...
/**
 * WebLicenseProofResponse Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLicenseProofResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.licenseProofResponse';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['checkUrl'] === null) {
            $invalidProperties[] = "'checkUrl' can't be null";
        }
     ...
     * Sets checkUrl
     *
     * @param string $checkUrl checkUrl
     *
     * @return self
     */
