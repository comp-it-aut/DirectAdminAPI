...
/**
 * WebSystemInfoSwap Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebSystemInfoSwap implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.systemInfoSwap';
    ...
    */
     ...
     * Sets freeBytes
     *
     * @param int $freeBytes /proc/meminfo `SwapFree`
     *
     * @return self
     */
     ...
     * Sets totalBytes
     *
     * @param int $totalBytes /proc/meminfo `SwapTotal`
     *
     * @return self
     */
     ...
     * Sets usedBytes
     *
     * @param int $usedBytes /proc/meminfo `SwapTotal-SwapFree`
     *
     * @return self
     */
