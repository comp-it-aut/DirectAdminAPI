...
/**
 * ApierrorAccountRoleMismatch Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class ApierrorAccountRoleMismatch implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'apierror.AccountRoleMismatch';
    ...
    public const TYPE_ACCOUNT_ROLE_MISMATCH = 'ACCOUNT_ROLE_MISMATCH';
    ...
    {
        return [
            self::TYPE_ACCOUNT_ROLE_MISMATCH,
        ];
    }
