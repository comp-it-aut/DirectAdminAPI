...
/**
 * WebFmMetadataSymlink Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebFmMetadataSymlink implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.fmMetadataSymlink';
    ...
    */
     ...
     * Sets resolved
     *
     * @param string $resolved Empty string means symlink is broken.
     *
     * @return self
     */
