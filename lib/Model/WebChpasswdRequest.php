...
/**
 * WebChpasswdRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebChpasswdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.chpasswdRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['newPassword']) > 256)) {
            $invalidProperties[] = "invalid value for 'newPassword', the character length must be smaller than or equal to 256.";
        }

        if ((mb_strlen($this->container['newPassword']) < 3)) {
            $invalidProperties[] = "invalid value for 'newPassword', the character length must be bigger than or equal to 3.";
        }
    ...
    public function setNewPassword($newPassword)
    {
        ...
        if ((mb_strlen($newPassword) > 256)) {
            throw new \InvalidArgumentException('invalid length for $newPassword when calling WebChpasswdRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($newPassword) < 3)) {
            throw new \InvalidArgumentException('invalid length for $newPassword when calling WebChpasswdRequest., must be bigger than or equal to 3.');
        }
