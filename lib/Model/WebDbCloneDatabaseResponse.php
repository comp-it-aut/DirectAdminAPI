...
/**
 * WebDbCloneDatabaseResponse Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebDbCloneDatabaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.dbCloneDatabaseResponse';
    ...
    */
     ...
     * Sets dbuser
     *
     * @param string|null $dbuser Empty if request dbuser is empty.
     *
     * @return self
     */
     ...
     * Sets hostPatterns
     *
     * @param string[]|null $hostPatterns Empty if request dbuser is empty.
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Empty if request dbuser is empty.
     *
     * @return self
     */
