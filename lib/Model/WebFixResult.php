...
/**
 * WebFixResult Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebFixResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.fixResult';
    ...
    */
     ...
     * Sets fixed
     *
     * @param int $fixed numebr of issues fixed
     *
     * @return self
     */
     ...
     * Sets issues
     *
     * @param int $issues number of issues remaining (failed to fix)
     *
     * @return self
     */
