...
/**
 * WebLoginResult Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLoginResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.LoginResult';
    ...
    */
     ...
     * Sets loginURL
     *
     * @param string $loginURL Can be used as browser navigation action to load DA from 3rd party domains
     *
     * @return self
     */
