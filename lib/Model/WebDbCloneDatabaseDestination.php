...
/**
 * WebDbCloneDatabaseDestination Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebDbCloneDatabaseDestination implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.dbCloneDatabaseDestination';
    ...
    */
     ...
     * Sets dbuser
     *
     * @param string|null $dbuser If non-empty, db user will be created.
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password If empty, password is auto-generated.
     *
     * @return self
     */
