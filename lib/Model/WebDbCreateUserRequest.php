...
/**
 * WebDbCreateUserRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebDbCreateUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.dbCreateUserRequest';
    ...
    */
     ...
     * Sets hostPatterns
     *
     * @param string[]|null $hostPatterns Valid values include wildcard '%', 'localhost', IPv4 and IPv6 addresses. At least one host pattern must exist but no more than 30.
     *
     * @return self
     */
