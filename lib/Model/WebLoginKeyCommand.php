...
/**
 * WebLoginKeyCommand Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLoginKeyCommand implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.loginKeyCommand';
    ...
    */
     ...
     * Sets available
     *
     * @param bool $available False if command is not available for current user
     *
     * @return self
     */
     ...
     * Sets role
     *
     * @param string $role Minimum role required to access the command
     *
     * @return self
     */
