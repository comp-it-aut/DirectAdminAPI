...
/**
 * WebSkinCustomizationsFile Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebSkinCustomizationsFile implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.skinCustomizationsFile';
    ...
    {
        $this->setIfExists('modTime', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['modTime'] === null) {
            $invalidProperties[] = "'modTime' can't be null";
        }
    ...
    {
        return $this->container['modTime'];
    }

    /**
     * Sets modTime
     *
     * @param \DateTime $modTime modTime
     *
     * @return self
     */
    ...
    {
        if (is_null($modTime)) {
            throw new \InvalidArgumentException('non-nullable modTime cannot be null');
        }
        $this->container['modTime'] = $modTime;
