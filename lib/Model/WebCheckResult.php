...
/**
 * WebCheckResult Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebCheckResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.checkResult';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('fixable', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['fixable'] === null) {
            $invalidProperties[] = "'fixable' can't be null";
        }
    ...
    {
        return $this->container['fixable'];
    }

    /**
     * Sets fixable
     *
     * @param bool $fixable fixable
     *
     * @return self
     */
    ...
    {
        if (is_null($fixable)) {
            throw new \InvalidArgumentException('non-nullable fixable cannot be null');
        }
        $this->container['fixable'] = $fixable;
     ...
     * Sets issues
     *
     * @param int $issues number of issues found
     *
     * @return self
     */
