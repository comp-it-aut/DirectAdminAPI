...
/**
 * WebFmTreeEntry Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebFmTreeEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.fmTreeEntry';
    ...
    protected static $openAPITypes = [
        'dirs' => '\COMPITAUT\DirectAdminAPI\Model\WebFmTreeEntry[]',
        'incomplete' => 'bool',
        'name' => 'string',
        'symlink' => 'bool'
    ];
    ...
    {
        $this->setIfExists('dirs', $data ?? [], null);
    ...
    */
     ...
     * Gets dirs
     *
     * @return \COMPITAUT\DirectAdminAPI\Model\WebFmTreeEntry[]|null
     */
    public function getDirs()
    {
        return $this->container['dirs'];
    }

    /**
     * Sets dirs
     *
     * @param \COMPITAUT\DirectAdminAPI\Model\WebFmTreeEntry[]|null $dirs dirs
     *
     * @return self
     */
    ...
    {
        if (is_null($dirs)) {
            throw new \InvalidArgumentException('non-nullable dirs cannot be null');
        }
        $this->container['dirs'] = $dirs;
     ...
     * Sets incomplete
     *
     * @param bool|null $incomplete Reports that entry wasn't fully traversed.
     *
     * @return self
     */
     ...
     * Sets symlink
     *
     * @param bool|null $symlink symlink
     *
     * @return self
     */
