...
/**
 * WebSystemInfoRAM Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebSystemInfoRAM implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.systemInfoRAM';
    ...
    protected static $setters = [
        'cachedBytes' => 'setCachedBytes',
        'freeBytes' => 'setFreeBytes',
    ...
    {
        $this->setIfExists('cachedBytes', $data ?? [], null);
        $this->setIfExists('freeBytes', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['cachedBytes'] === null) {
            $invalidProperties[] = "'cachedBytes' can't be null";
        }
        if ($this->container['freeBytes'] === null) {
            $invalidProperties[] = "'freeBytes' can't be null";
        }
     ...
     * @return int
     */
    public function getCachedBytes()
    {
        return $this->container['cachedBytes'];
    }

    /**
     * Sets cachedBytes
     *
     * @param int $cachedBytes /proc/meminfo `MemAvailable-MemFree`
     *
     * @return self
     */
    public function setCachedBytes($cachedBytes)
    {
        if (is_null($cachedBytes)) {
            throw new \InvalidArgumentException('non-nullable cachedBytes cannot be null');
        }
        $this->container['cachedBytes'] = $cachedBytes;
    ...
    {
        return $this->container['freeBytes'];
    }

    /**
     * Sets freeBytes
     *
     * @param int $freeBytes /proc/meminfo `MemFree`
     *
     * @return self
     */
    public function setFreeBytes($freeBytes)
    {
        if (is_null($freeBytes)) {
            throw new \InvalidArgumentException('non-nullable freeBytes cannot be null');
        }
        $this->container['freeBytes'] = $freeBytes;
     ...
     * Sets totalBytes
     *
     * @param int $totalBytes /proc/meminfo `MemTotal`
     *
     * @return self
     */
     ...
     * Sets usedBytes
     *
     * @param int $usedBytes /proc/meminfo `MemTotal-MemAvailable`
     *
     * @return self
     */
