...
/**
 * WebLoginKeyUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  COMPITAUT\DirectAdminAPI
 * @author   OpenAPI Generator team
 ...
 */
class WebLoginKeyUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'web.loginKeyUpdateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['password']) && (mb_strlen($this->container['password']) < 3)) {
     ...
     * Sets allowCommands
     *
     * @param string[]|null $allowCommands No restrictions if empty array.
     *
     * @return self
     */
     ...
     * Sets allowNetworks
     *
     * @param string[]|null $allowNetworks No restrictions if empty array.
     *
     * @return self
     */
     ...
     * Sets autoRemove
     *
     * @param bool|null $autoRemove autoRemove
     *
     * @return self
     */
     ...
     * Sets denyCommands
     *
     * @param string[]|null $denyCommands No restrictions if empty array.
     *
     * @return self
     */
     ...
     * Sets hasExpiry
     *
     * @param bool|null $hasExpiry hasExpiry
     *
     * @return self
     */
     ...
     * Sets password
     *
     * @param string|null $password Login key password.
     *
     * @return self
     */
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) > 256)) {
            throw new \InvalidArgumentException('invalid length for $password when calling WebLoginKeyUpdateRequest., must be smaller than or equal to 256.');
        }
        if ((mb_strlen($password) < 3)) {
            throw new \InvalidArgumentException('invalid length for $password when calling WebLoginKeyUpdateRequest., must be bigger than or equal to 3.');
        }
